...
class procurement_order(osv.osv):
    ...
    _columns = {
        'location_id': fields.many2one('stock.location', 'Procurement Location', select=True),  # not required because task may create procurements that aren't linked to a location with sale_service
    ...
    def run_scheduler(self, cr, uid, use_new_cursor=False, company_id=False, context=None):
        ...
        try:
            ...
            confirmed_ids = move_obj.search(cr, uid, [('state', 'in', ['confirmed', 'partially_available'])], limit=None, order='priority desc, date_expected asc', context=context)
