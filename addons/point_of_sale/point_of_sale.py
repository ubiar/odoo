...
class pos_order(osv.osv):
    ...
    _columns = {
        ...
        'amount_tax': fields.float('Impuestos', digits_compute=dp.get_precision('Account'), readonly=True),
        'amount_total': fields.float('Total', digits_compute=dp.get_precision('Account'), readonly=True),
        'amount_paid': fields.float('Paid', digits_compute=dp.get_precision('Account'), readonly=True),
        'amount_return': fields.float('Returned', digits_compute=dp.get_precision('Account'), readonly=True),
    ...
    def action_invoice(self, cr, uid, ids, context=None):
        ...
        for order in self.pool.get('pos.order').browse(cr, uid, ids, context=context):
            ...
            for line in order.lines:
                ...
                if inv_line.get('invoice_line_tax_id'):
