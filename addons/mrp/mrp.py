...
class mrp_production(osv.osv):
    ...
    def _make_consume_line_from_data(self, cr, uid, production, product, uom_id, qty, uos_id, uos_qty, context=None):
        ...
        if production.bom_id.routing_id and 'tercerizar' in production.bom_id.routing_id and not production.bom_id.routing_id.tercerizar and production.bom_id.routing_id.location_materia_prima_id and production.bom_id.routing_id.location_materia_prima_id.id != source_location_id:
