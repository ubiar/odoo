...
class configmanager(object):
    def __init__(self, fname=None):
        ...
        group.add_option("--filestore-dir", dest="filestore_dir", help="Directory where to store Odoo attachments files")
        ...
        levels = [
            ...
            'debug_sql', 'error', 'debug', 'debug_rpc_answer', 'notset', 'debug_exceptions', 'debug_function_fields'
        ]
    ...
    def _parse_config(self, args=None):
        ...
        keys = [
            ...
            'data_dir', 'filestore_dir', 'administrar_modulos'
        ]
