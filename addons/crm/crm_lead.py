...
class crm_lead(format_address, osv.osv):
    ...
    _columns = {
        ...
        'team_id': fields.many2one('crm.team', 'Equipo de Ventas', oldname='section_id',
        ...
        'opt_out': fields.boolean('Email Masivo', oldname='optout',
        ...
        'priority': fields.selection(crm.AVAILABLE_PRIORITIES, 'Prioridad', select=True),
        'date_closed': fields.datetime('Fecha de Cierre', readonly=True, copy=False),
        'stage_id': fields.many2one('crm.stage', 'Etapa', track_visibility='onchange', select=True,
                        domain="['&', ('team_ids', '=', team_id), '|', ('type', '=', type), ('type', '=', 'both')]"),
        'user_id': fields.many2one('res.users', 'Vendedor', select=True, track_visibility='onchange'),
        'referred': fields.char('Referido Por'),
        'date_open': fields.datetime('Asignado', readonly=True),
        ...
        'message_bounce': fields.integer('Cantidad Emails Rebotados', help="Counter of the number of bounced emails for this contact"),
